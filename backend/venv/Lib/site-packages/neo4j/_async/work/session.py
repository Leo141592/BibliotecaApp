...
class AsyncSession(AsyncWorkspace):
    ...
    context. For example::
        ...
        async with driver.session(database="59125830") as session:
    ...
    async def run(
        ...
        **kwargs: t.Any,
        ...
        .. note::
            See recommended usage: :ref:`async-auto-commit-caveats-ref`
        """
        self._check_state()
        if not query:
        ...
        while True:
            ...
            self._auto_result = auto_result = AsyncResult(
                cx,
